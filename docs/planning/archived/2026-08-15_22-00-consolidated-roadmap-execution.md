...
- The CLI fallback (`crush projects --json`) parses `CombinedOutput()` as
  ...
  _suspected_ live defect left in shipped code — verify before planning a fix.
...
_Snapshot generated 2026-08-15 22:00. Living tasks: TODO_LIST.md. Fully
executed (all C1–C21 + F1–F65 closed — see Status column and the F-table
resolution note); archived 2026-08-16 by the docs-health audit._
