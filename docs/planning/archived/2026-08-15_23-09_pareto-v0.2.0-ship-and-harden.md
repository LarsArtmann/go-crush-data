...
**Plan closure (2026-09-08, docs-health):** every deferred tail item has
since been closed or re-routed — m2.1 done (nightly fuzz green since
2026-08-17), m2.3 changed shape (flake-update's first run failed on
permissions; fixed 2026-09-08, TODO_LIST T3), m13.2 done (data point
posted on securego/gosec#1712), m1.5 done (pkg.go.dev crawled; renders
v0.3.0), m3.1 → TODO_LIST T1, m7.3 → TODO_LIST T6. Plan fully executed
and closed — archived.
